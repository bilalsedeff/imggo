-- Update publish_pattern_version function to handle format-specific schemas and template
...
BEGIN
  ...
  -- Insert version history with all schema types and template
  ...
  -- Update pattern with all schema types and template
...
COMMENT ON FUNCTION public.publish_pattern_version IS 'Create new version of pattern with format-specific schemas and template';
